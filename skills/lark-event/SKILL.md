...
| VC         | [`references/lark-event-vc.md`](references/lark-event-vc.md)                 | VC user events plus bot-observed EventKeys (`vc.bot.meeting_invited_v1`, `vc.bot.meeting_activity_v1`, `vc.bot.meeting_ended_v1`) + raw_event/stable field reference + post emotion guidance |
